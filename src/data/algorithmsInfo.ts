...
export const algorithmsData: Record<string, AlgorithmInfo> = {
  bubble: {
    ...
    year: "1956",
    story:
      "Bubble Sort's exact origins are lost to the mists of early computing folklore, but it was first analyzed in 1956. It gets its name from the way larger elements 'bubble' to the top of the list like carbonation in a soda. While it is famously inefficient, it remains one of the most widely taught algorithms because it introduces the fundamental concept of comparing and swapping adjacent elements in an intuitive, physical way.",
    complexities: {
      best: "O(n)",
      average: "O(n²)",
      worst: "O(n²)",
  ...
  cocktail: {
    ...
    year: "1973",
    story:
      "Also known as bidirectional bubble sort, this algorithm was formally documented by Donald Knuth in 'The Art of Computer Programming'. It aims to fix the 'turtle' problem in Bubble Sort, where small numbers at the end of the array move extremely slowly to the beginning. By sorting forwards (bubbling the max) and then sorting backwards (bubbling the min), it acts like a bartender shaking a cocktail.",
    complexities: {
      best: "O(n)",
      average: "O(n²)",
      worst: "O(n²)",
